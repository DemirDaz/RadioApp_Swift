...
class HostViewController: MenuContainerViewController {
    ...
    private func contentControllers() -> [UIViewController] {
       ...
       // let tweakController = TweakViewController.storyboardNavigationController()
        let viewController = ViewController.storyboardViewController()
        let viewController2 = ViewController.storyboardViewController()
        let viewController3 = ViewController.storyboardViewController()
        

        return [viewController,viewController2,viewController3]
    }
}
